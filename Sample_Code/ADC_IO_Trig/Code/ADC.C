...
void ADC_ISR (void) interrupt 11
{
    clr_ADCF;                               //clear ADC interrupt flag
		Send_Data_To_UART0(ADCRH);
    Send_Data_To_UART0(ADCRL);
}
...
----------------------------------------------------------------*/
		Enable_ADC_AIN4;															// Enable AIN0 P1.7 as ADC pin
		P13_FALLINGEDGE_TRIG_ADC;											// P0.4 falling edge as adc start trig signal
